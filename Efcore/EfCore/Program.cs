...
namespace EfCore
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //var fromID5 = db.Doctors.SingleOrDefault(d => d.Doctor_id == 5);
            //fromID5.salary -= amounttotransfer;
            //db.SaveChanges();
            //var toID6 = db.Doctors.SingleOrDefault(d => d.Doctor_id == 6);
            //toID6.salary += amounttotransfer;
            //db.SaveChanges();
            //transaction.Commit();

            //var p4 = db.Doctors.Select(d=>d);
            //foreach (var p in p4) 
            //{
            //    Console.WriteLine(p);
            //}
